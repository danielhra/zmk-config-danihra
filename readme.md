...
The whole keymap --- all five layers and all thirty combos --- is drawn in
[keymap.pdf](./keymap.pdf). The same sheet as a self-contained web page lives in
[keymap.html](./keymap.html); GitHub serves that one as source, so open the file
locally to read it.
